...
#ifndef _aspect_particle_property_cpo_bingham_average_part_h
#define _aspect_particle_property_cpo_bingham_average_part_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class CpoBinghamAverage_part : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * constructor
           */
          CpoBinghamAverage_part();
