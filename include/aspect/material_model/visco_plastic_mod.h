...
#ifndef _aspect_material_model_visco_plastic_mod_h
#define _aspect_material_model_visco_plastic_mod_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class ViscoPlasticMod : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
      ...
      private:
		...
		// tapering/cutting off the crust
        bool crust_cutoff;
        double crust_cutoff_depth;
        double crust_index;
        double crust_index2;
        bool crust_taper;
        bool two_crusts;
        double lower_crust_cutoff_depth;
        // crust eclogitization
        bool crust_eclogite;
        double eclogite_depth;
        double eclogite_density;
...
*/
        ...
        std::vector<double> prefactors_deep_diffusion;
        std::vector<double> activation_volumes_deep_diffusion;
        ...
        bool lower_mant_dislocation_creep;
        ...
        */
        ...
        std::vector<double> max_field_viscs;
        std::vector<double> min_field_viscs;
        std::vector<double> max_lowermant_field_viscs;
