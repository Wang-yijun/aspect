          ...
          if  ((this->get_timestep_number() > 0))
            {
              ...
              std::cout << "Saved viscosity: " << composition[ind_vis] << std::endl;
              if ((this->simulator_is_past_initialization()) && (in.temperature[q]>1000) && (determinant(deviatoric_strain_rate) != 0))
                {
