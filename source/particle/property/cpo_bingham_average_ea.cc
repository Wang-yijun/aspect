...
#include <aspect/particle/property/cpo_bingham_average_ea.h>
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
      ...
      template <int dim>
      void
      CpoBinghamAverageEA<dim>::update_particle_property(const unsigned int data_position,
      ...
      template <int dim>
      UpdateFlags
      CpoBinghamAverageEA<dim>::get_needed_update_flags () const
      {
      ...
      {
        prm.enter_subsection("CPO Bingham Average EA");
        {
